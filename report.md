...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test1(self):
        assert(Task1.currencyType in [1, 2, 3, 4]) #Test 1 Fails, currency from does not equal a valid currency.

    def test2(self):
        assert(Task1.currencyConvert in [1, 2, 3, 4]) #Test 1 Fails, currency to does not equal a valid currency.

    def test3(self):
        if Task1.currencyType == 1 and Task1.currencyConvert == 2:
            Task1.currencyAmount == 10
            assert(Task1.currencyAmount == 12) #Test 2 Fails, converting from GBP does not work.

    def test4(self):
        if Task1.currencyType == 2 and Task1.currencyConvert == 1:
            Task1.currencyAmount == 12
            assert(Task1.currencyAmount == 10) #Test 3 fails, converting to GBP does not work.
...
ELSE:
    ...
    RETURN int of c_type2
```
##Python code for the first task (This was my first attempt)
```python
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test1(self):
        a = '0000000001'
        b = '9'#put expected check digit here
    ...
    def test2(self):
        a = '0000000010'
        b = '8'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 2 fails answer is not as expected
    ...
    def test3(self):
        ...
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        print (t3.getCD(a))
        assert(t3.getCD(a)== a+b )#test 3 fails answer is not as expected

    def test4(self):
        a = '0000001000'
        b = '6'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 4 fails answer is not as expected

    def test5(self):
        a = '0000010000'
        b = '5'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 5 fails answer is not as expected

    def test6(self):
        a = '0000100000'
        b = '4'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 6 fails answer is not as expected

    def test7(self):
        a = '0001000000'
        b = '3'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 7 fails answer is not as expected

    def test8(self):
        a = '0010000000'
        b = '2'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 8 fails answer is not as expected

    def test9(self):
        a = '0100000000'
        b = '1'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 9 fails answer is not as expected

    def test10(self):
        a = '0200000010'
        b = 'X'#put expected check digit here
        #getCD returns the original ISBN Number (a) as well as the check digit (b)
        assert(t3.getCD(a)== a+b )#test 10 fails answer is not as expected
